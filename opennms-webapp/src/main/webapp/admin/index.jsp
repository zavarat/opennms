            ...
            <div class="collapse navbar-collapse">
                <ul class="flex-md-column flex-row navbar-nav w-100 justify-content-between">
                    <li class="nav-item active">
                        <a class="nav-link dropdown-toggle" href="#systemSubmenu" data-toggle="collapse" aria-expanded="false"><span><i class="fa fa-terminal"></i></span> System <span class="sr-only">(current)</span></a>
                        <ul class="flex-md-column flex-row navbar-nav w-100 justify-content-between pl-4 collapse" id="systemSubmenu">
                            <li class="nav-item"><a class="nav-link" href="admin/sysconfig.jsp">System Configuration</a></li>
                            <li class="nav-item"><a class="nav-link" href="admin/userGroupView/index.jsp">Configure Users, Groups and On-Call Roles</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link dropdown-toggle" href="#provisionSubmenu" data-toggle="collapse" aria-expanded="false">Provisioning</a>
                        <ul class="flex-md-column flex-row navbar-nav w-100 justify-content-between pl-4 collapse" id="provisionSubmenu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#">Flow Management</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">Service Monitoring</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">Performance Measurement</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">Distributed Monitoring</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">Additional Tools</a>
                    </li>
                    <li class="nav-item">
                        <a href="#homeSubmenu" data-toggle="collapse" aria-expanded="false" class="nav-link dropdown-toggle">Home</a>
                        <ul class="flex-md-column flex-row navbar-nav w-100 justify-content-between pl-4 collapse" id="homeSubmenu">
                            <li class="nav-item">
